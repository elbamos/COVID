...
update_map <- function(data, vis_options, map_name, input) {
...
observe(label="update_world_map", {
  ...
  map <- update_map(polys, vis_options, "worldview", input)
...
observe(label="update_usmap", {
  ...
  map <- update_map(us_cases_date_filtered(), vis_options, "usview", input)
